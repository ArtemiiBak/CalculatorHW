...
public class Calculator {
    ...
    public static String parse(String expression) throws Exception {
        ...
        if (operands.length != 2) throw new Exception("ERROR: There must be two operands");
        oper = detectOperation(expression);
        if (oper == null) throw new Exception("ERROR: Unsupported math operation");
        ...
        //если одни число римское, а другое - арабское
            ...
            throw new Exception("ERROR: Numbers must be in the same format");
        }
        if (num1 > 10 || num2 > 10) {
        ...
        if (isRoman) {
            ...
            if (arabian <= 0) {
                throw new Exception("ERROR: Roman numeral must be greater than zero");
            }
